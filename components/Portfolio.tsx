...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="section-padding bg-[#0d0d0d] relative overflow-hidden">
      ...
      <div className="container-custom relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-white/50 max-w-2xl mx-auto text-lg">
            A selection of our best work across industries and technology platforms.
          </p>
        </motion.div>
        ...
        >
          {CATEGORIES.map((cat) => (
            <button
              ...
              style={activeCategory === cat ? { boxShadow: '0 0 20px rgba(255,107,0,0.4)' } : {}}
            >
              {cat}
            </button>
          ))}
