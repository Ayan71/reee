...
const CONTACT_INFO = [
  { icon: Mail, label: 'Email Us', value: 'hello@codentrixa.com', href: 'mailto:hello@codentrixa.com' },
  { icon: Phone, label: 'Call Us', value: '+1 (555) 010-0100', href: 'tel:+15550100100' },
  { icon: MapPin, label: 'Visit Us', value: 'San Francisco, CA — Remote Worldwide', href: '#' },
];

const SERVICES_OPTIONS = [
  'MERN Stack Development', 'Flutter App Development', 'React Native',
  'Java Development', 'AI & Machine Learning', 'Full Stack Web',
  'Mobile App Development', 'API Integration', 'Cloud Deployment', 'UI/UX Design',
];
      ...
      <div className="container-custom relative z-10" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Start Your <span className="orange-text-gradient">Project</span>
          </h2>
          <p className="text-white/50 max-w-xl mx-auto text-lg">
            Ready to build something extraordinary? Let&apos;s discuss your vision and turn it into reality.
          </p>
        </motion.div>
          ...
          >
            {CONTACT_INFO.map((item, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-white text-sm font-medium group-hover:text-[#ff6b00] transition-colors">{item.value}</div>
                </div>
              </motion.a>
            ))}
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-2 text-white/30">
                <MapPin size={32} className="text-[#ff6b00]/50" />
                <span className="text-xs tracking-widest uppercase">San Francisco, CA</span>
                <span className="text-xs">Available Worldwide</span>
              </div>
              {/* Grid overlay glow */}
              <div className="absolute inset-0" style={{ background: 'radial-gradient(circle at 50% 50%, rgba(255,107,0,0.05) 0%, transparent 70%)' }} />
            </motion.div>
          </motion.div>
          ...
          >
            {submitted ? (
              ...
              >
                ...
                >
                  <CheckCircle size={60} className="text-[#ff6b00]" />
                </motion.div>
              ...
              >
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label className="block text-white/50 text-xs font-medium tracking-wider uppercase mb-2">Full Name *</label>
                    <input
                      type="text"
                      name="name"
                  ...
                  <div>
                    <label className="block text-white/50 text-xs font-medium tracking-wider uppercase mb-2">Email Address *</label>
                    <input
                      type="email"
                      name="email"
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-4">
                  <div>
                    <label className="block text-white/50 text-xs font-medium tracking-wider uppercase mb-2">Company</label>
                    <input
                      type="text"
                      name="company"
                  ...
                  <div>
                    <label className="block text-white/50 text-xs font-medium tracking-wider uppercase mb-2">Service Needed</label>
                    <select
                      name="service"
                ...
                <div className="mb-6">
                  <label className="block text-white/50 text-xs font-medium tracking-wider uppercase mb-2">Project Details *</label>
                  <textarea
                    name="message"
